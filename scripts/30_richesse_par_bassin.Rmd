...
```{r}
richesse_par_secteur_hydro <- geo_aggr_richesse(ope_geo_data = data_geo,
...
>Là on est fixé ! Le nombre d'opérations dans les bassins explique `r #r2`% de la variabilité des richesses. Ca interroge sur la représentation cartographique et son interprétabilité.
