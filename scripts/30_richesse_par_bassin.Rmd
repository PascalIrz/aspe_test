...
>NB Ici nous n'avons pas trié les espèces, qui sont au nombre de `r data %>% pull(esp_code_alternatif) %>% n_distinct()` dont des écrevisses, des hybrides ou des taxons identifiés au genre. Ce tri reste à faire.
...
mapview::mapview(richesse_par_bv, zcol = "richesse", col.regions = pal)
```
