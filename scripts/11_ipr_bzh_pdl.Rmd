...
Création du sous-jeu de données filtré pour le graphique. En outre, pour qu'une évolution temporelle ait un sens, il faut un minimum de données $\Rightarrow$ Sélection des stations avec 5 années de données ou plus.
...
```{r, fig.width = 10, fig.height = 14}
ipr_grapher_plusieurs_stations(ipr_df = data,
                               stations_id = NA,
                               premiere_annee = 2010,
                               derniere_annee = NA,
                               titre = "Côtes d'Armor",
