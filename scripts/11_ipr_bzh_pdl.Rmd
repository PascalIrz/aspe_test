---
title: "Les IPR en Bretagne - Pays de Loire"
author: "Pascal Irz"
date: "14/01/2021"
...
Comme cette table est assez importante (`r nrow(passerelle)` lignes) il est utile de la restreindre au périmètre qui nous intéresse. Ici, nous allons effectuer une sélection sur le département (codé par les deux premiers chiffres du code Insee de la commune). La sélection 
